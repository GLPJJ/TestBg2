...
import simple.view.tablayout.listener.OnTabSelectListener;
import simple.view.tablayout.utils.UnreadMsgUtils;
import simple.view.tablayout.widget.MsgView;
...
public class SlidingTabLayout extends HorizontalScrollView implements ViewPager.OnPageChangeListener {
    ...
    public void setViewPager(ViewPager vp) {
        setViewPagerCustom(vp, null);
    }

    /**
     * 关联ViewPager
     */
    public void setViewPagerCustom(ViewPager vp, @Nullable CustomTabViewInflater tabViewInflater) {
        if (vp == null || vp.getAdapter() == null) {
            throw new IllegalStateException("ViewPager or ViewPager adapter can not be NULL !");
        }

        mCustomTabViewInflater = tabViewInflater;
        this.mViewPager = vp;
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            if (mCustomTabViewInflater == null)//默认View
                tabView = View.inflate(mContext, R.layout.layout_tab, null);
            else//自定义View
                tabView = mCustomTabViewInflater.getTabView(LayoutInflater.from(mContext), pageTitle, i);
            addTab(i, pageTitle == null ? null : pageTitle.toString(), tabView);
        }
            ...
            public void onClick(View v) {
                ...
                if (position != -1) {
                    if (mViewPager.getCurrentItem() != position) {
                        mViewPager.setCurrentItem(position, !mSnapOnTabClick);
                        if (mListener != null) {
    ...
    public interface CustomTabViewInflater {
        View getTabView(LayoutInflater layoutInflater, CharSequence title, int pos);
    }

    CustomTabViewInflater mCustomTabViewInflater;
}
