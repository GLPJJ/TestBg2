...
public class DotSeekBar extends android.support.v7.widget.AppCompatSeekBar implements SeekBar.OnSeekBarChangeListener {
    ...
    boolean mIsDotDraw = true;//是否绘制节点
    ...
    public void setDotDrawable(Drawable progress, Drawable left, Drawable right) {
        mDrawDotLeft = left;
        mDrawDotRight = right;
    ...
    public void setDotDraw(boolean dotDraw) {
        mIsDotDraw = dotDraw;
        invalidate();
    }
